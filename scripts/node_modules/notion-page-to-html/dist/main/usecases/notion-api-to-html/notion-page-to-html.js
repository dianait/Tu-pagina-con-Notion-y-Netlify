    ...
    NotionPageToHtml.prototype._convert = function (pageURL, htmlOptions) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        pageId = factories_1.makeNotionUrlToPageIdFactory(pageURL).toPageId();
                        return [4 /*yield*/, factories_1.makeNotionApiPageFetcher(pageId)];
                    case 1:
                        fetcher = _a.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, factories_1.makeBlocksToHtml(blocks).convert()];
                    case 3:
                        htmlBody = _a.sent();
